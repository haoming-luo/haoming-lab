...
modal.insertAdjacentHTML('beforeend','<h2>本次工况：10 kN 静载</h2><p>原始模型与数据以1 kN载荷建立；当前线弹性任务按10倍载荷换算位移和应力，质量不变。已额外真实复算三种结构核对比例关系。该换算不适用于塑性、接触变化或大变形。</p><p>初始支架下沉0.032 mm，适中方案0.067 mm，纤细方案0.146 mm。0.10 mm是本演示的设计目标，可自行调整。这里展示刚度与用料的取舍，不给出材料屈服或结构安全认证。</p>');
